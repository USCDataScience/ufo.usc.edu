...
function showTooltip(d) {
	...
	d3.select("#tooltip-year").html("Fortnight Number: "+d.release);
	d3.select("#tooltip-title").html("Drinking Rate: "+d.title);
	d3.select("#tooltip-place").html("Position in Scatter Plot: " + d.position);
}//showTooltip	
